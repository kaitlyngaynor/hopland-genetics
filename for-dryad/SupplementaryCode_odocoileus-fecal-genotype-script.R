...
odo_data <- read.csv("SupplementaryData1_odocoileus-fecal-genotype-data.csv")
...
odo_data_1718swab <- read.csv("SupplementaryData2_odocoileus-fecal-genotype-data-20172018swab.csv")
